                        ...
                        <div class="card card-plain mt-8">
                            ...
                            <div class="card-body">
                                <form role="form" method="POST" action="/session">
                                    ...
                                    <label>Name</label>
                                    <div class="mb-3">
                                        <input type="text" class="form-control" name="name" id="name" placeholder="Username" aria-label="Username" aria-describedby="username-addon">
                                        @error('name')
                    ...
                    <div class="col-md-6">
                        <div class="oblique position-absolute top-0 h-100 d-md-block d-none me-n8">
                            <div class="oblique-image position-absolute fixed-top ms-auto h-100" 
                                style="background-image:url('../assets/img/buldingfront.jpg'); top: 0px; left: -500px; background-size: cover; z-index: 0;">
                            </div>
                        </div>
                    </div>
                </div>
